<section class="gray-rectangle-cta module ">
	<div class="grid-container">
		<div class="grid-x grid-padding-x text-center">
			<div class="cell small-12 tablet-10 tablet-offset-1 text-center">
			
				<div class="small-caps"><?php the_sub_field('small_heading');?></div>
				
				<?php if ( $large_copy = get_sub_field('large_copy') ):?>
				<p class="h2"><?php echo $large_copy; ?></p>
				<?php endif;?>
				
				<?php if ( $small_copy = get_sub_field('small_copy') ):?>
				<p><?php echo $small_copy; ?></p>
				<?php endif;?>		
